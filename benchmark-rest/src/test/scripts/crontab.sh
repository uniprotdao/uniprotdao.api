...
#10 07 * * * ${source_bashrc}; export LSF_JOB_TYPE="stress-idmapping"; ${source_lsf_uniprot_benchmark_params}; bsub -u uniprotdao -n $LSF_CORES -o $LSF_LOG -N -q $LSF_QUEUE -M $LSF_MEMORY -J "$LSF_JOB_NAME" -R $LSF_R_USAGE "/nfs/public/rw/homes/uni_ci/stress-tests/uniprot-api/bin/go-gatling IdMappingSimulation 4096m $LSF_JOB_TYPE"

#13 09 * * * ${source_bashrc}; export LSF_JOB_TYPE="stress-idmapping-kb"; ${source_lsf_uniprot_benchmark_params}; bsub -u uniprotdao -n $LSF_CORES -o $LSF_LOG -N -q $LSF_QUEUE -M $LSF_MEMORY -J "$LSF_JOB_NAME" -R $LSF_R_USAGE "/nfs/public/rw/homes/uni_ci/stress-tests/uniprot-api/bin/go-gatling IdMappingSimulation 4096m $LSF_JOB_TYPE"

#13 09 * * * ${source_bashrc}; export LSF_JOB_TYPE="stress-idmapping-uniparc"; ${source_lsf_uniprot_benchmark_params}; bsub -u uniprotdao -n $LSF_CORES -o $LSF_LOG -N -q $LSF_QUEUE -M $LSF_MEMORY -J "$LSF_JOB_NAME" -R $LSF_R_USAGE "/nfs/public/rw/homes/uni_ci/stress-tests/uniprot-api/bin/go-gatling IdMappingSimulation 4096m $LSF_JOB_TYPE"

#13 09 * * * ${source_bashrc}; export LSF_JOB_TYPE="stress-idmapping-uniref"; ${source_lsf_uniprot_benchmark_params}; bsub -u uniprotdao -n $LSF_CORES -o $LSF_LOG -N -q $LSF_QUEUE -M $LSF_MEMORY -J "$LSF_JOB_NAME" -R $LSF_R_USAGE "/nfs/public/rw/homes/uni_ci/stress-tests/uniprot-api/bin/go-gatling IdMappingSimulation 4096m $LSF_JOB_TYPE"